                ...
                <form id="form" method="POST">
                    ...
                    <div class="checkbox">
                        ...
                        <p>En soumettant ce formulaire, j'accepte que mes données personnelles soient utilisées pour me recontacter. 
                            ...
                            veuillez consultez <RouterLink to="/Politiquedeconfidentialite">la politique de confidentialité</RouterLink></p>
                    </div>
    ...
    .contact-row{
        ...
        .contact-card{
            ...
            .card.scale-in-center {
	            animation: scale-in-center 0.5s 0.3s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;
                &:hover{
